...
public class MenuTarjetas {
	...
	public static void menu(Scanner scanner, TarjetasIO tarjetasIO, Menu menu) throws NoExisteTarjeta, SQLException, NoExisteJugador, NoExistePartido {
		boolean salir = false;
		while (!salir) {
...
//ingue importar las otras partes tiene luciano ATT ANDERSSON ZURITA
